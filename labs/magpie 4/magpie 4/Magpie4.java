...
public class Magpie4
{
    ...
    public String getResponse(String statement)
    {
        ...
        else if (findKeyword(statement, "Maritza") >= 0
        ...
        else if (findKeyword(statement, "I", 0) >= 0) //Testing for "I something you statement"
        {
     ...
     * "What would you really be happy if you had <something>?"
    ...
    private String transformIYouStatement(String statement)
    {
        ...
        String restOfStatement = statement.substring(psnI + 2, psnyou).trim();
